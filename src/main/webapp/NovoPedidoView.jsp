...
<div id="wrapper">
	<div class="container-fluid">
			<h3>
				...
				Mesa: <input class="form-control" name="num_mesa" type="text" readonly value="${num_mesa }" pattern="[0-9]+$" required>
			</h3>
			<form>
				<table class="table"> 
					<tr>
				...
				<table class="table table-bordered table-condensed">
                    ...
                    %>
						<tr>
							...
							<td>
								<form>
									<input id="quantPedido<%=p.getCodigo() %>" min="1" value="1" type="number" style="width:50px" required></input>
								</form>
							</td>
							
							<td>
								<form>
									<a href="#" onclick="this.href='novo_pedido?operacao=adicionar&cod_comanda=<%=request.getAttribute("codigo_comanda")%>&codigo_produto=<%=p.getCodigo()%>&num_mesa=<%=request.getAttribute("num_mesa") %>&qntPedido='+document.getElementById('quantPedido<%=p.getCodigo() %>').value" >
